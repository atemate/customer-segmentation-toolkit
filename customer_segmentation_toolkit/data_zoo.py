...
__all__ = ['download_data_csv', 'BASE_URL', 'ENCODING', 'SUPPORTED_SUFFIXES']
...
def download_data_csv(path_relative: str, base_url: str = BASE_URL, encoding: str = ENCODING) -> pd.DataFrame:
